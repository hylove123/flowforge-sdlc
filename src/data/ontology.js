...
//  project in stages.js / project.customFlow.
// ================================================================
...
export const DEFAULT_TRACEABILITY_CHAIN = [
...
export const ONTOLOGY_RULES = [
  ...
  },
  {
    ...
    condition: (graph, entityId, context = {}) => {
      ...
      const reviews = graph.getRelations(entityId, 'REVIEWED_BY')
      if (reviews.length === 0) {
...
export function getTraceabilityRelations() {
...
export function buildTraceabilityChain(customFlow = null) {
